...
alter table player_dob_info add foreign key(player_id) references player(player_id);
alter table league add foreign key(country_name) references country(country_name);
alter table club add foreign key(league_id) references league(league_id);
alter table general_player add foreign key (player_id,season) references player(player_id,season);
alter table goalkeeper add foreign key (player_id,season) references player(player_id,season);
alter table player_best_position add foreign key(player_id,season) references player(player_id,season);
alter table player_best_position add foreign key(position_name) references positions(position_name);
alter table player_positional_rating add foreign key(player_id,season) references player(player_id,season);
alter table player_positional_rating add foreign key(position_name) references positions(position_name);
alter table player_tag add foreign key(player_id,season) references player(player_id,season);
alter table player_tag add foreign key(tag_name) references tag(tag_name);
